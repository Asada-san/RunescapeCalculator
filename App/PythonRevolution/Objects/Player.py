...
class Player:
    ...
    def __init__(self, userInput):
        ...
        if userInput['BerserkersFury'] != '' and 0 <= userInput['BerserkersFury'] <= 5.5:
        ...
        if userInput['baseDamage'] != '' and 0 <= userInput['baseDamage'] <= 10000:
        ...
        if userInput['ShieldArmourValue'] != '' and 0 <= userInput['ShieldArmourValue'] <= 1000:
            self.ShieldArmourValue = userInput['ShieldArmourValue']
        else:
            self.ShieldArmourValue = 491                # Shield Armour Value

        if userInput['DefenceLevel'] != '' and 0 <= userInput['DefenceLevel'] <= 200:
